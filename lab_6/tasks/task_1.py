...
"""
---------
Ta wersja programu uzywa biblioteki pandas.
Jezeli uzycie tej biblioteki jest niedozwolone prosze o sprawdzenie
programu z poprzedniego commitu. Dziekuje.
KS
---------
...
def select_animals(input_path, output_path, compressed=False):
    ...
    df['mass'] = df['mass'].apply(str_to_mass)
    print(df['mass'])
